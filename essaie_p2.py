...
st.set_page_config(layout="wide", page_title="EXAMEN DATA COLLECTION : SCRAPING")
...
with st.sidebar:
    ...
    with st.expander(" Formulaire", expanded=True):
        ...
        form_choice = st.selectbox(
            ...
            ["Formulaire de contact", "Formulaire SurveyCTO"]
        )
        
        # Formulaire de contact 
        if form_choice == "Formulaire de contact":
...
st.title("CoinAfrique Animal Scraper")
...
if 'form_choice' in locals() and form_choice == "Formulaire d'évaluation":
